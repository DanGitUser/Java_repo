...
public class JusoApi {
	public static void main(String[] args) throws Exception {
		...
		String key = "U01TX0FVVEgyMDI1MDQxNzEyNDYzOTExNTY2NDc=";
		String keyword = "구로동";
		String json = "json";
		
//		String req = String.format("%s?confmKey=$s&resultType=%s&keyword=%s",
//				url, key, json, URLEncoder.encode(keyword, "utf-8"));
